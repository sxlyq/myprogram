...
// LayerDoc.cpp : implementation of the CLayerDoc class
//
...
// CLayerDoc construction/destruction
...
void CLayerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CLayerDoc::InitializeSearchContent()
{
...
void CLayerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
